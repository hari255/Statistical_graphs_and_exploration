...
date: "2022-11-30"
output: pdf_document
---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


## setting up the workiong directory
...
pfizer <- read.csv("C:\\Users\\harin\\Statistical_graphs_and_exploration\\pfizer.xlsx")

Moderna <- read.csv ("C:\\Users\\harin\\Statistical_graphs_and_exploration\\moderna.xlsx")

janssen <- read.csv("C:\\Users\\harin\\Statistical_graphs_and_exploration\\janssen.xlsx")
```
...
```{r/ creating the desired datatframe week.all.state}
