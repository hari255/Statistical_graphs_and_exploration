...
pfizer <- read.csv("C:\\Users\\harin\\OneDrive\\Documents\\Statistical_graphs_and_exploration\\pfizer.xlsx")

Moderna <- read.csv <- ("C:\\Users\\harin\\OneDrive\\Documents\\Statistical_graphs_and_exploration\\Moderna.xlsx")

janssen <- read.csv("C:\\Users\\harin\\OneDrive\\Documents\\Statistical_graphs_and_exploration\\janssen.xlsx")
```
```{r}
